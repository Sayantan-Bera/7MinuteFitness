...
import com.example.a7minutefitness.databinding.ActivityBmiactivityBinding
//TODO binding
    ...
    private fun calculateUnits(){
        ...
        if (currentVisibleView == METRIC_UNITS_VIEW) {
            ...
            if (validateUsUnits()) {
                ...
                val heightValue =
                    usUnitHeightValueInch.toFloat()*0.0254f + usUnitHeightValueFeet.toFloat() * 0.3048f


                val bmi = (usUnitWeightValue / (heightValue * heightValue))
