...
import com.example.a7minutefitness.databinding.ActivityExerciseBinding
import com.example.a7minutefitness.databinding.DialogCustomBackConfirmationBinding
//TODO binding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            ...
            val soundURI =
                Uri.parse("android.resource://com.example.a7minutefitness/" + R.raw.ring)
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration * 1000, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                try {
                    ...
                    val soundURI =
                        Uri.parse("android.resource://com.example.a7minutefitness/" + R.raw.beep)
                    player2 = MediaPlayer.create(applicationContext, soundURI)
